...
np[th] = 0; rp[th] = 0; mp[th] = 0;
Spush_next(&&success,th);
Strace_next("init",0,0,0,th);
switch(pred){
case 0: goto fib;
case 1: goto color;
case 2: goto likes;
...
Senqueue("fib",2,2,1,"next");
Spush_next(&&fib_2_2_1,th);
Strace_next("fib",2,2,1,th);
subr_number = 187;
goto builtin_call;
fib_2_2_1:
Senqueue("fib",2,2,1,"path");
...
Strace_back("fib",2,2,1,th);
goto fib_2_2_1join;
fib_2_2_1back:
Senqueue("fib",2,2,1,"back");
varN1= back_stack[rp[th]+mode[th]][1][th];
varN2= back_stack[rp[th]+mode[th]][2][th];
varX1= back_stack[rp[th]+mode[th]][3][th];
varX2= back_stack[rp[th]+mode[th]][4][th];
varN= back_stack[rp[th]+mode[th]][5][th];
varX= back_stack[rp[th]+mode[th]][6][th];
Srelease(th);
fib_2_2_1join:
Senqueue("fib",2,2,1,"join");
next_stack[np[th]+1][1][th] = varN1;
next_stack[np[th]+1][2][th] = varN2;
next_stack[np[th]+1][3][th] = varX1;
next_stack[np[th]+1][4][th] = varX2;
next_stack[np[th]+1][5][th] = varN;
next_stack[np[th]+1][6][th] = varX;
Senqueue("fib",2,2,2,"next");
Spush_next(&&fib_2_2_2,th);
Strace_next("fib",2,2,2,th);
clause = Sget_choice(th);
goto fib_2;
fib_2_2_2:
Senqueue("fib",2,2,2,"path");
varN1= next_stack[np[th]+1][1][th];
varN2= next_stack[np[th]+1][2][th];
varX1= next_stack[np[th]+1][3][th];
varX2= next_stack[np[th]+1][4][th];
...
next_stack[np[th]+1][5][th] = varN;
next_stack[np[th]+1][6][th] = varX;
Senqueue("fib",2,2,3,"next");
Spush_next(&&fib_2_2_3,th);
Strace_next("fib",2,2,3,th);
subr_number = 187;
goto builtin_call;
fib_2_2_3:
Senqueue("fib",2,2,3,"path");
varN1= next_stack[np[th]+1][1][th];
varN2= next_stack[np[th]+1][2][th];
varX1= next_stack[np[th]+1][3][th];
varX2= next_stack[np[th]+1][4][th];
...
Strace_back("fib",2,2,3,th);
goto fib_2_2_3join;
fib_2_2_3back:
Senqueue("fib",2,2,3,"back");
varN1= back_stack[rp[th]+mode[th]][1][th];
varN2= back_stack[rp[th]+mode[th]][2][th];
varX1= back_stack[rp[th]+mode[th]][3][th];
varX2= back_stack[rp[th]+mode[th]][4][th];
...
next_stack[np[th]+1][5][th] = varN;
next_stack[np[th]+1][6][th] = varX;
Senqueue("fib",2,2,4,"next");
Spush_next(&&fib_2_2_4,th);
Strace_next("fib",2,2,4,th);
clause = Sget_choice(th);
goto fib_2;
fib_2_2_4:
Senqueue("fib",2,2,4,"path");
varN1= next_stack[np[th]+1][1][th];
varN2= next_stack[np[th]+1][2][th];
varX1= next_stack[np[th]+1][3][th];
varX2= next_stack[np[th]+1][4][th];
...
Strace_back("likes",2,4,0,th);
goto likes_2_4_0join;
likes_2_4_0back:
Senqueue("likes",2,4,0,"back");
varX= back_stack[rp[th]+mode[th]][1][th];
Srelease(th);
likes_2_4_0join:
Senqueue("likes",2,4,0,"join");
next_stack[np[th]+1][1][th] = varX;
Senqueue("likes",2,4,0,"end");
Spush_next(&&success,th);
clause = Sget_choice(th);
goto likes_2;
}
...
{
likes_2_5_0:
Senqueue("likes",2,5,0,"path");
arglist = Jwlistcons(varX,Jwlistcons(Jmakeconst("lee"),NIL,th),th);
Spush_back(&&likes_2_5_0back,arglist,th);
Strace_back("likes",2,5,0,th);
goto likes_2_5_0join;
likes_2_5_0back:
Senqueue("likes",2,5,0,"back");
varX= back_stack[rp[th]+mode[th]][1][th];
Srelease(th);
likes_2_5_0join:
Senqueue("likes",2,5,0,"join");
next_stack[np[th]+1][1][th] = varX;
Senqueue("likes",2,5,1,"next");
Spush_next(&&likes_2_5_1,th);
Strace_next("likes",2,5,1,th);
clause = Sget_choice(th);
goto likes_2;
likes_2_5_1:
Senqueue("likes",2,5,1,"path");
...
Strace_back("likes",2,5,1,th);
goto likes_2_5_1join;
likes_2_5_1back:
Senqueue("likes",2,5,1,"back");
varX= back_stack[rp[th]+mode[th]][1][th];
Srelease(th);
likes_2_5_1join:
Senqueue("likes",2,5,1,"join");
next_stack[np[th]+1][1][th] = varX;
Senqueue("likes",2,5,1,"end");
Spush_next(&&success,th);
clause = Sget_choice(th);
goto likes_2;
}
...
Strace_back("select1",3,1,0,th);
goto select1_3_1_0join;
select1_3_1_0back:
Senqueue("select1",3,1,0,"back");
varX= back_stack[rp[th]+mode[th]][1][th];
varYs= back_stack[rp[th]+mode[th]][2][th];
varY= back_stack[rp[th]+mode[th]][3][th];
varZs= back_stack[rp[th]+mode[th]][4][th];
Srelease(th);
select1_3_1_0join:
Senqueue("select1",3,1,0,"join");
next_stack[np[th]+1][1][th] = varX;
next_stack[np[th]+1][2][th] = varYs;
next_stack[np[th]+1][3][th] = varY;
next_stack[np[th]+1][4][th] = varZs;
Senqueue("select1",3,1,0,"end");
Spush_next(&&success,th);
clause = Sget_choice(th);
goto select1_3;
}
...
{
perm1_2_1_0:
Senqueue("perm1",2,1,0,"path");
arglist = Jwlistcons(varX,Jwlistcons(varXs,Jwlistcons(varZs,NIL,th),th),th);
Spush_back(&&perm1_2_1_0back,arglist,th);
Strace_back("perm1",2,1,0,th);
goto perm1_2_1_0join;
perm1_2_1_0back:
Senqueue("perm1",2,1,0,"back");
Strap(th);
varZs= back_stack[rp[th]+mode[th]][1][th];
varXs= back_stack[rp[th]+mode[th]][2][th];
varX= back_stack[rp[th]+mode[th]][3][th];
varYs= back_stack[rp[th]+mode[th]][4][th];
Srelease(th);
perm1_2_1_0join:
Senqueue("perm1",2,1,0,"join");
next_stack[np[th]+1][1][th] = varZs;
next_stack[np[th]+1][2][th] = varXs;
next_stack[np[th]+1][3][th] = varX;
next_stack[np[th]+1][4][th] = varYs;
Senqueue("perm1",2,1,1,"next");
Spush_next(&&perm1_2_1_1,th);
Strace_next("perm1",2,1,1,th);
clause = Sget_choice(th);
goto select1_3;
perm1_2_1_1:
Senqueue("perm1",2,1,1,"path");
...
Strace_back("perm1",2,1,1,th);
goto perm1_2_1_1join;
perm1_2_1_1back:
Senqueue("perm1",2,1,1,"back");
varZs= back_stack[rp[th]+mode[th]][1][th];
varXs= back_stack[rp[th]+mode[th]][2][th];
varX= back_stack[rp[th]+mode[th]][3][th];
varYs= back_stack[rp[th]+mode[th]][4][th];
Srelease(th);
perm1_2_1_1join:
Senqueue("perm1",2,1,1,"join");
next_stack[np[th]+1][1][th] = varZs;
next_stack[np[th]+1][2][th] = varXs;
next_stack[np[th]+1][3][th] = varX;
next_stack[np[th]+1][4][th] = varYs;
Senqueue("perm1",2,1,1,"end");
Spush_next(&&success,th);
clause = Sget_choice(th);
goto perm1_2;
}
